        ...
        <div class="navbar-header"  style="width: 25%;">
            ...
            <a class="navbar-brand" href="<?php echo base_url();?>index.html">
                ...
                foreach($logo as $logo)
                {
					...
					if ($logo->title == "Ultimate Solution") 
					{
...
if( $i < 5 )
{
  if($company_id == 2)
  {
	  $final_url=base_url()."ultimate_solution/".addunderscores(strtolower($cat_name)).".html";
        //echo $final_url;
        ?>
...
-->
   ...
   echo '<li class="dropdown yamm-fw"><a href="'.$final_url.'"><span></span>' . ucwords($cat_name) . '</a>';
