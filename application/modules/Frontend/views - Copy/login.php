            ...
            <div id="content" class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <a href="<?php echo base_url(); ?>register.html" class="btn btn-primary">Continue</a> </div>
                    <div class="col-sm-6">
                        <h2 class="subtitle">Returning Customer</h2>
                        <form class="form-validate-login" action="<?php echo base_url(); ?>login_submit.html" method="post">
                            <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo base_url(); ?>forgot_password.html">Forgot password?</a>
