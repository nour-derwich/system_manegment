            ...
            <div id="content" class="col-sm-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td>Image</td>
                            <td class="text-center"><img class="img-thumbnail" title="Laptop Silver black" alt="Laptop Silver black" src="<?php echo base_url();?>/public_html/frontend/image/product/macbook_air_1-90x90.jpg"></td>
                            <td class="text-center"><img class="img-thumbnail" title=" Strategies for Acquiring Your Own Laptop " alt=" Strategies for Acquiring Your Own Laptop " src="<?php echo base_url();?>/public_html/frontend/image/product/macbook_pro_1-90x90.jpg"></td>
                            <td class="text-center"><img class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" src="<?php echo base_url();?>/public_html/frontend/image/product/samsung_tab_1-90x90.jpg"></td>
                        </tr>
                        <tr>
                            <td>Price</td>
