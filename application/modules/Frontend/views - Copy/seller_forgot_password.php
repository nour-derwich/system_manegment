...
<div class="container">
    ...
    <header class="page-header">
        <h1 class="page-title">Seller Forgot password</h1>
        <ol class="breadcrumb page-breadcrumb">
            <li><a href="<?php echo base_url(); ?>index.html">Home</a>
            </li>
            <li class="active">Seller Forgot password</li>
        </ol>
...
<form class="form-horizontal form-validate-forgot" action="<?php echo base_url(); ?>seller_forgot_password_submit.html" method="post">
<?php
