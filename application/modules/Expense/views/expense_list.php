            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-header">
                        Results for Expense
                        <a href="<?php echo base_url('Expense/expense_action'); ?>" class="pull-right btn bigger-50 ws-btn-font  btn-success">Add New </a>
                    </div>
...
<?php
			...
			?>                                    
									<td><?php 
									$country_name = $this->Mdl_expense->get_relation_pax('country_list','country_name','id',$row->country_id);
									echo $country_name;?></td>
									<td><?php $city_name = $this->Mdl_expense->get_relation_pax('city_list','city_name','id',$row->city_id);
									echo $city_name;?></td>
				...
				?>						
                                        ...
                                        <td><?php $exp_name = $this->Mdl_expense->get_relation_pax('expense_type_list','expense_type_name','id',$row->expense_type_id);
									echo $exp_name;?></td>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green" href="<?php echo base_url('Expense/expense_action/'.$row->id.''); ?>">
                                            ...
                                            <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                <div class="inline position-relative">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                        ...
                                                        <li>
                                                            <a href="<?php echo base_url('Product/category_action/'.$row->id.''); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                <span class="green">
