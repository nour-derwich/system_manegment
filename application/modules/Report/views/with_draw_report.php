...
<div class="page-content">
   ...
   <div class="row">
        <div class="col-xs-12 col-sm-12">
            ...
            echo form_open(base_url('Report/with_draw_report_action'), $attributes);
            ?>
            ...
            <div class="col-sm-12" style="margin-top:5px; padding:0px;">
                <div class="col-sm-4 form-group mr0" style="margin-bottom: 0px;">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="clearfix">
                            <input type="text" value="" id="exp_name" name="exp_name" placeholder="With Draw Name" class="col-xs-12 col-sm-12" />
