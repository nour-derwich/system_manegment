...
$building_expense_dd         = Modules::run('Hierarchy/building_expense_dd');
$city_name = $this->Mdl_buildingexpense->get_relation_pax('city_list','city_name','id',$row[0]->city_id);

$project_name = $this->Mdl_buildingexpense->get_relation_pax('project_list','project_name','id',$row[0]->project_id);
?>
<div class="page-content">
    ...
    <div class="page-header">
        <h1>
            ...
            <a href="<?php echo base_url('BuildingExpense/expense_list'); ?>" class="pull-right btn bigger-50 ws-btn-font  btn-success">List View</a>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7">
            ...
            echo form_open_multipart(base_url('BuildingExpense/expense_submit'), $attributes);
            ?>
            <!-- PAGE CONTENT BEGINS -->
		   ...
		   <?php
		    ...
		    <div class="form-group">
			 ...
			 <div class="form-group">
                ...
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="Name">Project</label>
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <select id="project_id" required name="project_id" placeholder="Project" class="project project_id col-xs-10 col-sm-9 required-field ">
                                  <?php
						if($id > 0 )
						{
							?>
							<option value="<?php echo $row[0]->project_id; ?>"><?php echo $project_name; ?></option>
							<?php
						}else
						{
						?>
			 ...
			 <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        ...
                        echo form_dropdown(
                            'expense_type_id',
                            $building_expense_dd,$row[0]->expense_type_id,
           ...
           <div class="space-2"></div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <textarea id="exp_des" rows="5" name="exp_des" placeholder="Expense Description" class="col-xs-10 col-sm-9 required-field"><?php echo $row[0]->exp_des;?></textarea>
                    </div>
                </div>
            </div>
...
-->
            ...
            <div class="clearfix form-actions" style="text-align: center;">
                <div class="col-md-9 ">
                    <a class="btn"  href="<?php echo base_url('BuildingExpense/expense_list'); ?>">
