...
class Mdl_buyer extends CI_Model
{
    ...
    public function get_payment_list($payment_id)
    {
       ...
       // $this->db->order_by('order_id','desc');
        ...
        return $query->result();
		    ...
		    //Paymtnt List
    public function get_remainig_payment_list($order_code)
    {
        $this->db->select('*');
        if($order_code != "")
        {
 ...
 //All CArt List
    ...
    public function sub_category_list($parm)
    {
	 ...
	 //Product List
    public function get_product_list_dd($parm,$sub)
    {
        $this->db->select('*');
        $this->db->where('is_enable',1);
        $this->db->where('category_id',$parm);
    ...
    public function _get_single_product_byCategory($id)
    {
        $this->db->select('*');
