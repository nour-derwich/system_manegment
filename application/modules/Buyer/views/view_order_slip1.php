...
else
{
  ...
  //echo $order_code;
$order_list = $this->Mdl_buyer->get_order_list_by_code($order_code);
$user_list = $this->Mdl_buyer->_this_controller_record($order_list[0]->user_id);
$cart_list = $this->Mdl_buyer->get_order_cart_list($order_code);
$payment_list = $this->Mdl_buyer->get_order_payment_list($order_code);
//echo "<pre>";/
...
<table id="meta" style="float: left;">
            ...
            <table id="meta">
                <tr>
                    ...
                    <td><textarea readonly><?php echo $order_code; ?></textarea></td>
                </tr>
                <tr>
