...
$(".country").change(function(){
        ...
        $(".state").change(function(){
            ...
            $('#search_cat_id').change(function()
            {
                ...
                var request = $.ajax(
                    {
                        url: "<?php echo base_url('Buyer/get_subcategory_byid'); ?>",
                        type: "POST",
                        data: json,
                        dataType: "html",
                        beforeSend : function()
                ...
                var request = $.ajax(
                    {
                        ...
                        success : function(_return)
                        {
                           ...
                           // $('#scat_id').html(_return);
							...
							$("#cname").val(_return['_return1'][0]);
							$("#sname").val(_return['_return1'][1]);
							$("#pname").val(_return['_return1'][2]);
