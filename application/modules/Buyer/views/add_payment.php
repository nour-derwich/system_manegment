...
$user_dd         = Modules::run('Hierarchy/buyer_dd');
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7">
            ...
            echo form_open_multipart(base_url('Buyer/partial_payment_submit'), $attributes);
            ?>
            <!-- PAGE CONTENT BEGINS -->
		...
		<div class="form-group">
                ...
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="Name">Slip No</label>
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <input type="text" id="slip_no" name="slip_no" value="" placeholder="Slip No" class="col-xs-10 col-sm-9" />
                    </div>
                </div>
            </div>
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <input type="text" id="paid_price_payment" name="paid_price_payment" value="" placeholder="Paid Price" class="col-xs-10 col-sm-9 required-field paid_price_payment" />
                    </div>
                </div>
            </div>
