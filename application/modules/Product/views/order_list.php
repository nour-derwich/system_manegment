...
$user_dd         = Modules::run('Hierarchy/get_user_list');
?>
		  		...
		  		<div class="col-md-12">
		  			<table class="table-responsive table-condensed">
                        ...
                        echo form_dropdown(
                            ...
                            'class  ="search_cat_id"
                        id     ="search_cat_id" placeholder="Category"');
                        ?>
		  						</td>
		  						<td>
		  							 <select name="scat_id" id="scat_id" placeholder="Sub Category"  class="scat_id" >
                            <option value="">Select Sub Category</option>
		  						...
		  						<td>
		  							...
		  							<input type="text" id="pname" readonly name="pname" style="" class="form-control" placeholder="" value="">
								
		  						</td>
		  						<td>
								<input type="text" id="pprice" name="pprice" style="" readonly class="form-control" placeholder="" value="">
								  ...
								  <input type="text" id="sprice" name="sprice" style="" class="form-control" placeholder="" value="">
		  						...
		  						<td>
									  ...
									  <textarea id="otherf" style="" name="otherf" class="form-control" placeholder="" value=""></textarea>
									 
		  						</td>
		  						<td>
		  							<input type="text" id="otherp" name="otherp" class="form-control" placeholder="" value="">
		  						</td>
								<td>
...
$("#insert").click(function () {
	...
	var qty = $("#qty").val();
	var otherf = $("#otherf").val();
	var otherp = $("#otherp").val();
    ...
    var markup = "<tr><td><input type='checkbox' class='' name='record'></td><td><input type='text' class='form-control' readonly name='cat[]' value='" + cat + "'></td><td><input type='text' class='form-control' readonly name='scat[]' value='" + scat_id + "'></td><td><input type='hidden' class='form-control' readonly name='pid[]' value='" + pid + "'><input type='text' class='form-control' readonly name='pname[]' value='" + pname + "'></td><td><input type='text' readonly name='pprice[]' class='form-control' value='" + pprice + "'></td><td><input type='text' class='form-control' readonly name='sprice[]' value='" + sprice + "'></td><td><input type='text' class='form-control' readonly name='qty[]' value='" + qty + "'></td><td><input type='text' readonly name='otherf[]' class='form-control' value='" + otherf + "'></td><td><input type='text' class='form-control' readonly name='otherp[]' value='" + otherp + "'></td><td><input type='text' readonly class='form-control' name='totalp[]' value='" + totalp + "'></td></tr>";
