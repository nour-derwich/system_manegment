...
$payment_list = $this->Mdl_Account->get_payment_list($payment_id);
                             ...
                             /*    foreach($result_set as $key => $row) { */
                                    ...
                                    <tr>
                                        <td class="sku"><?php //echo $row->username;
                                            $product_code = $this->Mdl_Account->get_relation_pax('product_list','product_code','id',$order_list[0]->product_id);
											echo $product_code; ?>
										...
										echo $order_list[0]->product_id;
                                            ...
                                            $product_name = $this->Mdl_Account->get_relation_pax('product_list','product_name','id',$order_list[0]->product_id);
                                            echo $product_name;
...
<tbody>
	...
	<tr>
		...
		<td style="width:0.75in" align="right" class="price">Rs. <?php echo $payment_list[0]->paid_price; ?></td>
	</tr>
	<tr>
		<td align="right" class="label price">
			Remaining Price:
