            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-header">
                        ...
                        <a href="<?php echo base_url('Product/category_action'); ?>" class="pull-right btn bigger-50 ws-btn-font  btn-success">Add New </a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green" href="<?php echo base_url('Product/category_action/'.$row->id.''); ?>">
