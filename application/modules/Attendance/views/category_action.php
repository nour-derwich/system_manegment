...
<div class="page-content">
    ...
    <div class="page-header">
        <h1>
            ...
            <a href="<?php echo base_url('Product/category_list'); ?>" class="pull-right btn bigger-50 ws-btn-font  btn-success">List View</a>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7">
            ...
            echo form_open_multipart(base_url('Product/category_submit'), $attributes);
            ?>
            <!-- PAGE CONTENT BEGINS -->
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <input type="text" id="cat_name" name="cat_name" value="<?php echo $row[0]->category_name;?>" placeholder="Category Name" class="col-xs-10 col-sm-9 required-field" />
                    </div>
                </div>
            </div>
...
-->
            ...
            <div class="clearfix form-actions" style="text-align: center;">
                <div class="col-md-9 ">
                    <a class="btn"  href="<?php echo base_url('Product/category_list'); ?>">
