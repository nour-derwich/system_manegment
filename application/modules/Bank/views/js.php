    ...
    jQuery(function($) 
        {
            ...
            //CAtegory_table
            var oTable1 = $('#bank_table').dataTable(
                {
                    "aoColumns":
                        [
                            { "bSortable": true },
            ...
            //Check_table
            var oTable1 = $('#check_table').dataTable(
                {
                    "aoColumns":
                        [
                            { "bSortable": true },
				 ...
				 //Check_table
            var oTable1 = $('#check_table1').dataTable(
                {
                    "aoColumns":
                        [
                            { "bSortable": true },
            ...
            $(".bank_status").change(function(){
                ...
                if(ref != null)
                {
                    ...
                    var request = $.ajax({
                        url: "<?php echo base_url('Bank/change_bank_status'); ?>",
                        type: "POST",
                        data: json,
                        dataType: "json",
