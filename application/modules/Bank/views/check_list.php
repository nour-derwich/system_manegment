            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-header">
                        Results for Cheque List
                        <a href="<?php echo base_url('Bank/check_action'); ?>" class="pull-right btn bigger-50 ws-btn-font  btn-success">Add New </a>
                    </div>

                    <div class="table-responsive">
                        <table id="check_table" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                            ...
                            foreach($result_set as $key => $row) {
                               ...
                               // print_r($result_set);
                                ...
                                <tr <?php if($row->check_status == "Clear"){ echo "class='green1'"; }?>>
									...
									<select name="check_status" id="check_status" onchange="check_status2(this.value, <?= $row->id; ?>)" placeholder="Check Status"  class="col-xs-10 col-sm-12 fee_status" >
                    ...
                    <option <?php if($row->check_status == "Not Clear"){ echo "selected"; }?>  value="Not Clear" >Not Clear</option>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            ...
                                            <a class="blue" href="<?php echo base_url('Bank/check_action/'.$row->id.''); ?>">
                                        ...
                                        <div class="visible-xs visible-sm hidden-md hidden-lg">
                                            <div class="inline position-relative">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url('Bank/check_action/'.$row->id.''); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                <span class="green">
