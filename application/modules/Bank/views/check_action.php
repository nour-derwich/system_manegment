...
<div class="page-content">
    ...
    <div class="page-header">
        <h1>
            ...
            <a href="<?php echo base_url('Bank/check_list'); ?>" class="pull-right btn bigger-50 ws-btn-font  btn-success">List View</a>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7">
            ...
            echo form_open_multipart(base_url('Bank/check_submit'), $attributes);
            ?>
            <!-- PAGE CONTENT BEGINS -->
		   ...
		   <div class="space-2"></div>
            ...
            <div class="clearfix form-actions" style="text-align: center;">
                <div class="col-md-9 ">
                    ...
                    <a class="btn"  href="<?php echo base_url('Bank/check_list'); ?>">
