...
class Project extends MX_Controller  
{
    ...
    function __construct()
    {
        ...
        $this->admin_email = $this->Mdl_Project->_get_admin_email();
    }

    public function index()
    {    
       $data['result_set'] = $this->Mdl_Project->_get_category_list();
        $data['content']  = 'Project/category_list';
    ...
    {    
       //$data['result_set'] = $this->Mdl_Project->_get_category_list();
        $data['content']  = 'Project/project_action';
        $this->load->view('Template/template',$data);
    }
public function edit_project($id)
    {    
      $data['result'] = $this->Mdl_Project->_get_Project_list($id);
        $data['content']  = 'Project/project_action';
        $this->load->view('Template/template',$data);
    }
    //Category List
    ...
    {
        $data['result_set'] = $this->Mdl_Project->_get_sub_category_list();
        $data['content']  = 'Project/sub_category_list';
        $this->load->view('Template/template',$data);
    }
    ...
    {
       $data['result'] = $this->Mdl_Project->_get_Project_list();
        $data['content']  = 'Project/Project_list';
        $this->load->view('Template/template',$data);
    }
    ...
    public function order_list()
    {
        ...
        $data['content']  = 'Project/order_list';
        $this->load->view('Template/template',$data);
    }
    //Order List
    public function view_order_list()
    {
        $data['result_set'] = $this->Mdl_Project->_get_order_list();
        $data['content']  = 'Project/view_order_list';
        $this->load->view('Template/template',$data);
    }
    ...
    public function category_action()
    {
        ...
        if($id > 0)
        {
            $data['result_set'] = $this->Mdl_Project->_get_category_list($id);
        }
        $data['content']  = 'Project/category_action';
        $this->load->view('Template/template',$data);
    }
    ...
    public function sub_category_action()
    {
        ...
        if($id > 0)
        {
            $data['result_set'] = $this->Mdl_Project->_get_sub_category_list($id);
        }
        $data['content']  = 'Project/sub_category_action';
        $this->load->view('Template/template',$data);
    }
    ...
    {
        $id = $this->uri->segment(3);
        $data['get_Project'] = $this->Mdl_Project->_get_single_Project($id);
        $data['content']  = 'Project/Project_action';
        $this->load->view('Template/template',$data);
    }
    ...
    public function category_submit()
    {
        ...
        if($post['id'] > 0)
        {
            ...
            if($_FILES['cat_img']['name']!="")
            {
                ...
                $db_command = $this->Mdl_Project->db_command($data_p_relation,$post['id'],'category_list');
            ...
            if($db_command)
            {
                ...
                redirect(base_url().'Project/category_list','refresh');
        ...
        else
        {
          ...
          //  exit;
            ...
            $db_command = $this->Mdl_Project->db_command($data_p_relation,null,'category_list');
            $this->db->trans_complete();
            if($db_command)
            {
                if($post['id'] > 0)
        ...
        if($post['id'] > 0)
        {
            ...
            else
            {
                if($post['image_status'] == 1) {
                    ...
                    $db_command = $this->Mdl_Project->db_command($data_p_relation1, $post['id'], 'category_list');
                    $this->db->trans_complete();
                }else
                {
                    $this->db->trans_start(); // Query will be rolled back
            ...
            if($db_command)
            {
                ...
                redirect(base_url().'Project/sub_category_list','refresh');
        ...
        if($post['id'] > 0)
        {
            ...
            $data_p_relation =
                ...
                (
                    ...
                    'weapon_name'             => $post['prject_name'],                  
                    'material_cost'         => $post['material_cost'],           
                    'other_expense'         => $post['other_expense'],  
                    'wpntype'             => $post['wpntype'],                  
                    'wpncalibre'         => $post['wpncalibre'],           
                    'wpnnumber'         => $post['wpnnumber'], 
    ...
    $db_command = $this->Mdl_Project->db_command($data_p_relation,$post['id'],'weapon_list');
            $this->db->trans_complete();
            if($db_command)
            {
                if($post['id'] > 0)
                ...
                redirect(base_url().'Project/Project_list','refresh');
            }
            else
            {
                $this->session->set_flashdata('Error', 'your data has not been saved');
        ...
        $post = $this->input->post();
            ...
            $db_command =     $this->db->insert('weapon_list',$data_p_relation);
            //$db_command = $this->Mdl_Project->db_command($data_p_relation,null,'weapon_list');
                        ...
                        <div class="table-responsive ">
                            <table id="Project-table" class="table table-striped table-bordered table-hover">
                                ...
                                foreach($result as $res):
                                    ...
                                    $category_name = $this->Mdl_Project->get_relation_pax('category_list','category_name','id',$res->category_id);
                                    if($res->user_type == "seller") {
                                        $seller_name = $this->Mdl_Project->get_relation_pax('seller_list', 'company', 'id', $res->created_by);
                                    }else
                                    {
                                        $seller_name = "--";
                                    }
                                    $subcategory_name = $this->Mdl_Project->get_relation_pax('category_list','category_name','id',$res->subcategory_id);
                                   // $currency_name = $this->Mdl_Project->get_relation_pax('currency_list','code','id',$fc->currency_id);
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="green btn" target="_blank" href="<?php echo base_url('Project/add_order/'.$res->id.''); ?>">
                                               Buy Now
                                            </a>
                                        </td>
            ...
            jQuery(function($)
            {
                ...
                $(".Project_status").change(function(){
                    ...
                    if(ref != null)
                    {
                        ...
                        var request = $.ajax({
                            url: "<?php echo base_url('Project/change_Project_status'); ?>",
                            type: "POST",
                            data: json,
                            dataType: "json",
                           // dataType: "html",
  ...
  /*              //Discount Status Change
                $(".discount_status").change(function(){
                    ...
                    if(ref != null)
                    {
                        ...
                        json['status']   = status_new;
                        var request = $.ajax({
                            url: "<?php //echo base_url('Project/change_discount_status'); ?>",
                            type: "POST",
                            data: json,
                            dataType: "json",
...
*/
   ...
   //Add New Order
	...
	/* 	$get_order = $this->Mdl_Project->_get_order_code_generator();
        ...
        $data['content']  = 'Project/add_order';
        $this->load->view('Template/template',$data);
    ...
    {
        $data['content']  = 'Project/add_payment';
        $this->load->view('Template/template',$data);
    }
    ...
    {	
		...
		exit; */
				...
				if($paid_price < $order_remaining_amount1)
				{
					...
					$db_command = $this->Mdl_Project->db_command($data_p_relation2111,null,'payment_list');
            ...
            if($db_command)
            {
				...
				//$data['content']    = 'Project/view_order_slip';
				$this->load->view('Project/view_order_slip',$data);
            }
            else
            {
                $this->session->set_flashdata('Error', 'your payment has not been saved');
                redirect(base_url().'Project/add_payment','refresh');
    ...
    public function order_submit()
    {
		...
		//$this->db->trans_start(); // Query will be rolled back
            ...
            $db_command = $this->Mdl_Project->db_command($data_p_relation1,null,'user_list');
            ...
            $db_command = $this->Mdl_Project->db_command($data_p_relation1,$post['order_user_id'],'user_list');
            ...
            $db_command = $this->Mdl_Project->db_command($data_p_relation_order,null,'order_list');
            ...
            $db_command = $this->Mdl_Project->db_command($data_p_relation_cart,null,'cart_list');
            //$db_command = $this->db->insert('order_list', $data_p_relation_order);
			$last_cart_id = $this->db->insert_id();
				 ...
				 $get_Project_quantity = $this->Mdl_Project->get_relation_pax('Project_list','Project_quantity','id',$pid);
            ...
            $db_command = $this->Mdl_Project->db_command($data_p_relation2,null,'payment_list');
            ...
            else
            {
                ...
                redirect(base_url().'Project/add_order/'.$post['Project_id'],'refresh');
    ...
    public function view_image()
    {
        ...
        $data['content']  = 'Project/Project_view_image';
        $this->load->view('Template/template',$data);
    ...
    {
        $data['result_set'] = $this->Mdl_Project->_this_controller_record_customer_distribution(); 
        $data['content']  = 'Project/distribution';
        $this->load->view('Template/template',$data);   
    }
    ...
    { 
        ...
        if($id > 0)
        {
            $data['result_set'] = $this->Mdl_Project->_get_single_record_byid($id,'customer');  
        } 

        $data['content']   = 'Project/customer_action';
        $this->load->view('Template/template',$data);
    }
    ...
    public function customer_command()
    {
        ...
        {
            $code_gen = $this->Mdl_Project->_get_customer_code_generator();		
        }
        ...
        $amount = $this->Mdl_Project->check_already_exists_multiple('category_channel',$data_output,$data_amount,2);
        ...
        if($post['login_id'] != null)
        {
            ...
            $db_command =  $this->Mdl_Project->db_command($data_login,$post['login_id'],'login');
        ...
        else
        {
            ...
            $db_command =  $this->Mdl_Project->db_command($data_login,null,'login');
        ...
        if($post['customer_id'] != null)
        {
            ...
            $db_command =  $this->Mdl_Project->db_command($data_customer,$post['customer_id'],'customer');
            //$last_login_id = $post['login_id'];
        }
        else
        {	
            ...
            $db_command =  $this->Mdl_Project->db_command($data_customer,null,'customer');
            //$last_login_id = $this->db->insert_id();
        }
		$this->db->trans_complete(); 
        if($db_command)
        {
            if($post['customer_id'] != null)
            {
                ...
                $this->session->set_flashdata('update', 'your data successfully Updated');  
                redirect(base_url()."Project/customer",'refresh'); 
            }
            else
            {
                ...
                $this->session->set_flashdata('saved', 'your data successfully Saved'); 
                redirect(base_url()."Project/success/$get_code/$code_gen/$get_code",'refresh'); 
            }
    ...
    {
        //$data['result_set'] = $this->Mdl_Project->_this_controller_record_customer_distribution(); 
        $data['content']  = 'Project/payment_receiving';
        $this->load->view('Template/template',$data);   
    }
    ...
    public function payment_receiving_search()
    {
        ...
        $result_payment =  $this->Mdl_Project->_payment_receiving_search($search_payment);
        //echo "<pre>";
                            ...
                            <table id="payment_table" class="table table-striped table-responsive table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php foreach($result_payment as $fc): 
                                        ...
                                        $category_name = $this->Mdl_Project->get_relation_pax('category_list','title','id',$fc->category_id);
                                        $distribution_name = $this->Mdl_Project->get_relation_pax('distribution_channel','title','id',$fc->dis_channel_id);
                                        $currency_name = $this->Mdl_Project->get_relation_pax('currency_list','code','id',$fc->currency_id);
                                        ?>
                                        <tr>
                                            <td class="center">
    ...
    public function payment_submit()
    {
		...
		foreach($data_post['checkbox_customer'] as $chk)
        {
            ...
            $mobile_no = $this->Mdl_Project->get_relation_pax('customer','mobile_no','id',$chk);
            $shipping = $this->Mdl_Project->get_relation_pax('customer','shipping','id',$chk);
            $amount = $this->Mdl_Project->get_relation_pax('customer','amount','id',$chk);
            $noofcopy = $this->Mdl_Project->get_relation_pax('customer','noofcopy','id',$chk);
            $customer_code = $this->Mdl_Project->get_relation_pax('customer','customer_code','id',$chk);
            ...
            $db_command =  $this->Mdl_Project->db_command($data_customer,$chk,'customer');
		...
		foreach($data_post['slip_no'] as $slp_key => $slp_val)
        {
            ...
            $db_command =  $this->Mdl_Project->db_command($data_customer,$slp_key,'customer');
		}	
		...
		foreach($data_post['payment_date'] as $slp_keys => $slp_vals)
        {
            ...
            $db_command =  $this->Mdl_Project->db_command($data_customer,$slp_keys,'customer');
		}
		
		
        $this->session->set_flashdata('update', 'your payment has been received successfully');  
        redirect(base_url()."Project/payment_receiving",'refresh'); 
    }
    ...
    {
        //$data['result_set'] = $this->Mdl_Project->_this_controller_record_customer_distribution(); 
        $data['content']  = 'Project/mailing_list';
        $this->load->view('Template/template',$data);   
    }
                            ...
                            <table id="mailing_table" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php foreach($filtered_customer as $fc): 
                                        ...
                                        $Project_name = $this->Mdl_Project->get_relation_pax('Project_list','title','id',$fc->Project_id);
										 $location_name = $this->Mdl_Project->get_relation_pax('location_list','title','id',$fc->location_id);
                                        ?>
                                        <tr>
                                            <td class="center">
                                                <!--<label>
                                            ...
                                            <td><?php echo $fc->noofcopy; ?> </td>
                                            <td>
                                                <a href="<?php echo base_url('Project/print_card/'.$fc->inv_id.''); ?>" class="tooltip-error" data-rel="tooltip" title="View" target="_blank" >
                                                    <span class="purple">
    ...
    public function dispatch_submit()
    {
       ...
       // echo "<pre>";
		...
		foreach($data_post['checkbox_dispatch'] as $chk)
        {
		   ...
		   //Quantity ID
			$quantity_id_get = $this->Mdl_Project->get_relation_pax('inv_distribution','quantity','id',$chk);
			
			
		   //Customer ID
			$customer_id_get = $this->Mdl_Project->get_relation_pax('inv_distribution','customer_id','id',$chk);
			
			//Dispatch Quantity Get
			$dispatch_quantity_get = $this->Mdl_Project->get_relation_pax('customer','dispatch_quantity','id',$customer_id_get);
            ...
            $db_command =  $this->Mdl_Project->db_command($data_inv,$chk,'inv_distribution'); 
            ...
            $db_command =  $this->Mdl_Project->db_command($data_customer,$customer_id_get,'customer'); 
        ...
        redirect(base_url()."Project/dispatch_list",'refresh'); 
    }
    ...
    public function print_card()
    {
        ...
        if($id != null)
        {
            if($id  == 0)
            {
                ...
                redirect(base_url().'Project/mailing_list','refresh');   
            }
            else
            {
                $this->db->where('id',$id);
                ...
                $city_name = $this->Mdl_Project->get_relation_pax('city_list','title','id',$filtered_customer[0]->city_id);
                $location_name = $this->Mdl_Project->get_relation_pax('location_list','title','id',$distribution[0]->location_id);
                //echo "<pre>";
    ...
    { 
        ...
        if(isset($_POST['save_inventory']))
        {
            ...
            $db_command =  $this->Mdl_Project->db_command($data,$post['id'],'inv_receiving');
            if($db_command)
            {
                if($post['id'] != null)
                {
                ...
                redirect(base_url().'Project/inventory_receiving','refresh');  
            } 
        }
        else 
        {
    ...
    {
        //$data['result_set'] = $this->Mdl_Project->_this_controller_record_customer_distribution(); 
        $data['content']  = 'Project/resend_sms';
        $this->load->view('Template/template',$data);   
    }
    ...
    public function recent_sms_submit()
    {
        ...
        redirect(base_url()."Project/resend_sms",'refresh'); 
    }
    ...
    public function check_user_exists()
    {
        ...
        $id 	=  $post['id'];
        $cmd_return         =  $this->Mdl_Project->_get_single_record_byusername($username,$id);
    ...
    public function check_email_exists()
    {
        ...
        $email           =  $post['email'];
        $id                 =  $post['id'];
        $cmd_return         =  $this->Mdl_Project->_get_single_record_byemail($email,$id);
    ...
    public function check_phone_exists()
    {
        ...
        $mobile_no           =  $post['mobile_no'];
        $id                 =  $post['id'];
        $cmd_return         =  $this->Mdl_Project->_get_single_record_byphone($mobile_no,$id);
    ...
    public function get_category_channel_list()
    {
        ...
        $data = $this->Mdl_Project->_get_category_channel_list($category_id,$dis_channel_id);



        if($data[0]->rate > 0)
        {
            $currency = $this->Mdl_Project->get_relation_pax('currency_list','code','id',$data[0]->currency_id);
    ...
    public function get_subcategory_byid()
    {
        ...
        $data['result_set'] = $this->Mdl_Project->sub_category_list($search_cat_id);
    ...
    public function get_Project_byid()
    {
        ...
        $_return['_return'] = $this->Mdl_Project->_get_single_Project_byCategory($search_cat_id,$scat_id);
        $return             = json_encode($_return);
        echo $return;
    ...
    public function change_category_status()
    {
        ...
        $_return['_return'] =  $this->Mdl_Project->_change_category_status($id,$status);
        $return             = json_encode($_return);
        echo $return;
    ...
    public function change_Project_status()
    {
        ...
        $_return['_return'] =  $this->Mdl_Project->_change_Project_status($id,$status);
        if($_return['_return'] == 1)
        {
            //Active Account
            if($status == 0)
            {
                $seller_detail = $this->Mdl_Project->_this_seller_controller_record($seller_id);
    ...
    public function change_discount_status()
    {
        ...
        $_return['_return'] =  $this->Mdl_Project->_change_discount_status($id,$status);
        $return             = json_encode($_return);
        echo $return;
