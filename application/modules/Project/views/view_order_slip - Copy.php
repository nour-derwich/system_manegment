...
$order_list = $this->Mdl_product->get_order_list($order_id);
//$order_list = $this->Mdl_product->get_order_list($order_id);
//echo "<pre>";
//print_r($order_list);
	...
	<tr>
		...
		<td style="width:2.5in">
			...
			<tr>
				...
				<td><?php echo $order_list[0]->name; ?></td>
			</tr>
			<tr>
                             ...
                             /*    foreach($result_set as $key => $row) { */
                                    ...
                                    <tr>
                                        <td class="sku"><?php //echo $row->username;
                                            $product_code = $this->Mdl_product->get_relation_pax('product_list','product_code','id',$order_list[0]->product_id);
											echo $product_code; ?>
                                        ...
                                        <td><?php
                                            ...
                                            $product_name = $this->Mdl_product->get_relation_pax('product_list','product_name','id',$order_list[0]->product_id);
                                            echo $product_name;

                                            ?></td>
										<td align="right" class="price">Rs. <?php echo $order_list[0]->sell_price; ?></td>
                                        <td align="center">
                                            <?php echo $order_list[0]->qty; ?>

                                        </td>
                                       
                                        <td align="right" class="price"> Rs. <?php
                                            $sub_total = ($order_list[0]->qty * $order_list[0]->sell_price);
                                            echo $sub_total;
...
<tbody>
	...
	<tr>
		...
		<td style="width:0.75in" align="right" class="price">Rs. <?php echo $order_list[0]->other_charges; ?></td>
	</tr>
	<!--<tr>
		<td align="right" class="label price">
...
<!-- END Order Footer -->
<a class="btn" href="<?php echo base_url(); ?>Account/order_list" >Back</a>
</div>
