...
$order_list = $this->Mdl_product->get_order_list_by_code($order_code);
$payment_list = $this->Mdl_product->get_order_payment_list($order_code);
$cart_list = $this->Mdl_product->get_order_cart_list($order_code);
//echo "<pre>";/
/* print_r($order_list);
...
$user = $this->Mdl_product->_get_user_list($order_list[0]->user_id);
                              ...
                              foreach($cart_list as $key => $row) { 
                                    ...
                                    <tr>
                                        <td class="sku"><?php //echo $row->username;
                                            $product_code = $this->Mdl_product->get_relation_pax('product_list','product_code','id',$row->product_id);
											echo $product_code; ?>
										...
										//echo $order_list[0]->product_id;
                                          //  $product_id_array = $order_list[0]->product_id.",".$product_id_array;
                                            $product_name = $this->Mdl_product->get_relation_pax('product_list','product_name','id',$row->product_id);
                                            echo $product_name;
