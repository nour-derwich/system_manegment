                        ...
                        <table id="payment_list_table" class="table table-striped table-bordered table-hover">
							...
							{ ?>
                                ...
                                <tr>
									...
									<?php
									$total_price= $this->Mdl_Account->get_relation_pax('order_list','total_price','order_code',$row->order_code);
 ...
 <td>Rs. <?php echo $row->paid_price;?></td>                                   
									...
									<td>
                                        <div class="action-buttons">
                                            <a target="_blank" class="btn btn-xs" href="<?php echo base_url('Account/view_order_slip/'.$row->payment_id.'/'.$row->order_code.''); ?>">
                                            View Slip
