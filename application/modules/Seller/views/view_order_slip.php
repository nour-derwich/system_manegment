...
}else
{
  ...
  $payment_list = $this->Mdl_seller->get_payment_list($payment_id);
...
<a href="<?php echo base_url(); ?>Seller/order_list" class="btn_back" name="" type="submit">
	...
	<div id="page-wrap">
		...
		<div id="identity" style="width: 100%;height: 100px !important;">
            ...
            <textarea readonly id="address" style="width: 30%;" >Note: Company are not Responsible for patches on Chinese Media</textarea>
...
<table id="meta" style="float: left;">
            ...
            <table id="meta">
                <tr>
                    ...
                    <td align="center" style="text-align: center;" ><textarea readonly style="border-bottom:1px solid #333;text-align: center;">0000<?php echo $payment_id; ?></textarea></td>
                </tr>
                <tr style="display:none;">
		...
		<div style="clear:both"></div>    
            ...
            <!--<textarea id="customer-title">Widget Corp.
c/o Steve Widget</textarea>-->
<table id="meta" style="width:100%;margin: 1% 0%;" >
                <tr>
  ...
  <tr>
		 ...
		 ?> 
		  <tr class="item-row">		     
		      ...
		      <td><textarea class="cost" style="width:200px !important;" readonly><?php echo $cart->job; ?></textarea></td>
		  ...
		  <tr>
		      ...
		      <td class="total-value" colspan="2"><div id="paid">Rs. <?php echo $paid; ?></div></td>
		  </tr>
		  <tr>
		  ...
		  <textarea readonly id="address"><?php echo $system_info[0]->long_address;?>
                           ...
                           Email: ultimatesign2011@gmail.com	
							Cell: 0321-2421289, 0300-2421289, 03459017090, 0333-3517525, 0313-1058651							
                    Website: www.ultimateprintingsolutions.com	
