...
//print_r($row);
$city_name = $this->Mdl_users->get_relation_pax('city_list','city_name','id',$row[0]->city_id);
$branch_name = $this->Mdl_users->get_relation_pax('branch_list','branch_name','id',$row[0]->branch_id);
$project_name = $this->Mdl_users->get_relation_pax('project_list','project_name','id',$row[0]->project_id);
?>
    ...
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <div class="clearfix">
                       <?php
                        echo form_dropdown(
                            ...
                            'class  ="col-xs-12 col-sm-6 country_id country required-field "
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                       <select id="city_id" name="city_id" placeholder="City" class="col-xs-12 col-sm-6 city city_id  required-field ">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <select id="branch_id" name="branch_id" placeholder="Branch" class="col-xs-12 col-sm-6 branch branch_id required-field ">
                                   <?php /* if($id != null){ ?>
									<option value="<?php echo $row[0]->branch_id; ?>"><?php echo $branch_name; ?></option>
									<?php
									}else{
									?>
            ...
            <div class="space-2"></div>-->
			  ...
			  <div class="form-group">
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="password">Project:</label>
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <select id="project_id" name="project_id" placeholder="Project" class="col-xs-12 col-sm-6 project project_id required-field ">
                                   <?php if($id != null){ ?>
