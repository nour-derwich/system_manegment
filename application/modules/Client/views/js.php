...
$(".country").change(function(){
        ...
        $(".city").change(function(){
            ...
            var request = $.ajax({
				  ...
				  $("#cash").blur(function()
                    {
						...
						var final_toal = (parseInt(cash) + parseInt(loan) + parseInt(documentation)) - parseInt(discount);
						$("#total_cost").val(parseInt(final_toal));
					});
				 ...
				 $("#discount").blur(function()
                    {
						...
						else if(!isNaN($("#discount").val()) == true)
						{
							discount = $("#discount").val();	
						}
						else
				 ...
				 $("#documentation").blur(function()
                    {
						...
						else if(!isNaN($("#documentation").val()) == true)
						{
							documentation = $("#documentation").val();	
						}
						else
				...
				//Check File No Already Exit		
				   //Check cnic exit
            $('.check_fileno_exists').blur(function()
                {
					//alert("YES");
                    var search_input     = $("#fileid").val();
                    var json             = {};
                   
                        json['fileid']   = search_input;
                        var request = $.ajax({
                            url: "<?php echo base_url('Client/search_client_by_fileno'); ?>",
                            type: "POST",
                            data: json,
                            dataType: "json",
                            beforeSend : function()
								...
								{	
                                    $.gritter.add({
                                       ...
                                       // text: search_input+' this File No Already Exists with Name '+details.name,
                                        text: search_input+' this File No Already Exists ',
		...
		//Search Client FILE List
            $("#search_fileno_submit").click(function()
            {
                    if($("#search_fileno").val() == "")
					{
						$("#search_fileno").focus();
					}
					else
					{						
						 var json = {};
						json['search_fileno'] = $("#search_fileno").val();
						var request = $.ajax({
						url: "<?php echo base_url('Client/search_by_fileno'); ?>",
						type: "POST",
						data: json,
						dataType: "html",
						success : function(_return)
						{
							//console.log(_return);
							$('.search_fileid_result').html(_return); 
						}
						});                      
					}
           }); 
				...
				//Form Validation Add New Client Start
            $('.form-validate-client').validate({
                ...
                rules: {
					...
					soname  : {	required: true  },
					postal_address  : {	required: true  },
					cottage_no  : {	required: true  },
					co  : {	required: true  },
					floor  : {	required: true  },
					cnic  : {	required: true  },
					relation  : {	required: true  },
					nomine  : {	required: true  },
					nomine_address  : {	required: true  },
					cash  : {	required: true  },
					loan  : {	required: true  },
                ...
                messages: {
                    ...
                    fileid    : " Please enter file no ",
                    contact2    : " Please enter other contact number ",
                    name    : " Please enter name ",
                    contact1    : " Please enter contact number",
                    soname    : " Please enter S/O, D/O, W/O",
                    postal_address    : " Please enter postal address ",
                    cottage_no    : " Please enter cottage no",
                    co    : " Please enter C/O ",
                    floor    : " Please enter floor",
                    cnic    : " Please enter cnic",
                    relation    : " Please enter relation",
                    nomine    : " Please enter nomine",
                    nomine_address    : " Please enter nomine address",
                    cash    : " Please enter cash",
                    loan    : " Please enter loan",
                    total_cost    : " Please enter total cost",
                    schedule_date    : " Please select schedule date",
                    discount    : " Please enter discount",
                    documentation    : " Please enter documentation ",
			...
			//Form Validation Add New Client End
	
				//Form Validation Payment Start
            $('.form-validate-payment').validate({
                ...
                rules: {
					...
					payment_description  : {	required: true  },
					remarks  : {	required: true  },
					check_img  : {	required: true  },
					check_no  : {	required: true  },
					check_bank_name  : {	required: true  },
					check_branch_name  : {	required: true  },
					pay_img  : {	required: true  },
					pay_no  : {	required: true  },
					pay_bank_name  : {	required: true  },
					pay_branch_name  : {	required: true  },
					online_account_from  : {	required: true  },
					online_bank_from  : {	required: true  },
					online_branch_from  : {	required: true  },
					online_account_to  : {	required: true  },
					online_bank_to  : {	required: true  },
					online_branch_to  : {	required: true  },
                ...
                messages: {
                    ...
                    payment_description    : " Please select payment description ",
                    remarks    : " Please enter remarks ",
                    check_img    : " Please select check image ",
                    check_no    : " Please enter check no ",
                    check_bank_name    : " Please enter bank name ",
                    check_branch_name    : " Please enter branch name ",
                    pay_img    : " Please select pay order image ",
                    pay_no    : " Please enter pay order no",
                    pay_bank_name    : " Please enter bank name ",
                    pay_branch_name    : " Please enter branch name ",
                    online_account_from    : " Please enter account no from ",
                    online_bank_from    : " Please enter bank name from ",
                    online_branch_from    : " Please enter branch name from ",
                    online_account_to    : " Please enter account no to ",
                    online_bank_to    : " Please enter bank name to ",
                    online_branch_to    : " Please enter branch name to",
                },
                invalidHandler: function (event, validator) { //display error alert on form submit
                    $('.alert-danger', $('.form-validate')).show();
                },
	...
	//Form Validation File Start
            $('.form-validate-file').validate({
                ...
                rules: {
					...
					//client_file  : {	required: true  },
				},
                messages: {
                    detail    : " Please enter detail ",
                  //  client_file    : " Please select file ",
                },
                invalidHandler: function (event, validator) { //display error alert on form submit
                    $('.alert-danger', $('.form-validate')).show();
                },
				  ...
				  $("#paid").blur(function()
                    {
						...
						if(paid > remaining_amount)
						{
						 ...
						 $.gritter.add({
                                        // (string | mandatory) the heading of the notification
                                        title: 'Paid Amount Erroe!',
                                        // (string | mandatory) the text inside the notification
                                       // text: search_input+' this File No Already Exists with Name '+details.name,
                                        text: 'please enter paid amount less than or equal to remaining amount.',
                                        class_name: 'gritter-danger  gritter-light'
                                    });
                                    //$('.check_fileno_exists').val(''); 
									$("#paid").val('');
		...
		//Client ADD End JS
		//Client Record Search Start
		
		//Search Client Record List
            $("#search_client_record_submit").click(function()
            {					
						 var json = {};
						json['country_id'] = $("#country_id").val();
						json['city_id'] = $("#city_id").val();
						json['branch_id'] = $("#branch_id").val();
						json['fileid'] = $("#fileid").val();
						json['date'] = $("#date").val();
						json['name'] = $("#name").val();
						json['contact1'] = $("#contact1").val();
						var request = $.ajax({
						url: "<?php echo base_url('Client/search_by_client_record'); ?>",
						type: "POST",
						data: json,
						dataType: "html",
						success : function(_return)
						{
							//console.log(_return);
							$('.search_result_client_record').html(_return); 
						}
						});
           }); 
		
		
		//Search Client History List
            $("#search_client_history_submit").click(function()
            {					
						 var json = {};
						json['country_id'] = $("#country_id").val();
						json['city_id'] = $("#city_id").val();
						...
						json['contact1'] = $("#contact1").val();
						var request = $.ajax({
						url: "<?php echo base_url('Client/search_by_client_history'); ?>",
						type: "POST",
						data: json,
						dataType: "html",
						success : function(_return)
                ...
                $("#payment_type").change(function()
                    {
						 var json = {};
						json['payment_type'] = $("#payment_type").val();
						var request = $.ajax({
						url: "<?php echo base_url('Client/payment_type_change'); ?>",
						type: "POST",
						data: json,
						dataType: "html",
						success : function(_return)
