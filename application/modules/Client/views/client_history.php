    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12">
			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-target="#deal" href="#">Client History</a>
			</div>
		...
		<div class="col-md-4">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-9">
				      <input type="text" id="email" name="email" value="" placeholder="Email" class="form-control required-field">
				    </div>
				</div>
...
<div class="form-group">
				...
				<button class="btn btn-info btn-sm btn-validate" name="search_client_history_submit" id="search_client_history_submit" type="button">
                                ...
                                foreach($client_record as $res):
                                   ...
                                   ?>
                                    <tr>
										...
										<td>
                                            <a class="green btn-xs btn" target="_blank" href="<?php echo base_url('Client/add_amount/'.$res->id.''); ?>">
											Add Amount
                                            </a>
                                        </td>
										<td>
                                            <a class="green btn-success btn-xs btn" target="_blank" href="<?php echo base_url('Client/view_complete_client_detail/'.$res->id.''); ?>">
                                               View Detail
                                            </a>
                                        </td>
										<!--<td>
                                            <a class="green btn-sm btn" target="_blank" href="<?php echo base_url('Client/edit_client_detail/'.$res->id.''); ?>">
												Edit
                                            </a>
                                        </td>-->
										<td>
                                            <a class="green btn-success btn-xs btn" target="_blank" href="<?php echo base_url('Client/file_detail/'.$res->id.''); ?>">
                                              Go to
                                            </a>
                                        </td>
